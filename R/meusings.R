...
#
#
# PointsInPolygon <- function(dt_polygons, dt_points){
#
# 	## put every point against every polygon
# 	dt_polygons[, key := 1]
# 	dt_points[, key := 1]
#
# 	dt <- dt_polygons[ dt_points, on = "key", allow.cartesian = T]
#
#
...
# # #
# # # google_map(key = map_key) %>%
# # # 	add_polylines(data = dt_scot, lat = "coords.V2", lon = "coords.V1", id = "id")
# # #
# # #
# #
# #
